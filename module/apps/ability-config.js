...
export default class ActorAbilityConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["skjaald"],
      template: "systems/skjaald/templates/apps/ability-config.html",
      width: 500,
      height: "auto"
    });
  }
  ...
  /** @override */
  get title() {
    return `${game.i18n.format("SKJAALD.AbilityConfigureTitle", {ability: CONFIG.SKJAALD.abilities[this._abilityId]})}: ${this.document.name}`;
  }
